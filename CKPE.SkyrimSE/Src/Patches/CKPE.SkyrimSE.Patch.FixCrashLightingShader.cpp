...
namespace CKPE
{
	namespace SkyrimSE
	{
		namespace Patch
		{
			...
			bool FixCrashLightingShader::SupportsAddressLibrary() const noexcept(true)
			{
				return true;
			}
			...
			bool FixCrashLightingShader::DoActive([[maybe_unused]] Common::RelocatorDB::PatchDB* db) noexcept(true)
			{
				...
				//
				auto addr = Relocation(ID(200136), Offset{ 0x4E0, 0x4E5 }).Address();
