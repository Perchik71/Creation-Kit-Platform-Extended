...
namespace CKPE
{
	namespace SkyrimSE
	{
		namespace Patch
		{
			...
			{
				std::uint64_t PatchLinkedList(std::uintptr_t beg, std::uintptr_t end) const noexcept(true);
				std::uint64_t PatchTemplatedFormIterator(std::uintptr_t _beg, std::uintptr_t _end) const noexcept(true);
