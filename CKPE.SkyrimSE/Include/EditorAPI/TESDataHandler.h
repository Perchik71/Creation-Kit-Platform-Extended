...
#include <EditorAPI/Forms/BGSMaterialType.h>
	...
	namespace SkyrimSE
	{
		namespace EditorAPI
		{
			...
			public:
				...
				BSTArray<Forms::TESLandTexture*> arrLandTexture;				// 248 Form Type 20
				...
				BSTArray<Forms::TESObjectLIGH*> arrLight;						// 350 Form Type 31 <LIGH>
				...
				BSTArray<Forms::TESObjectCELL*> arrCell;						// 608 Form Type 60 <CELL>
				BSTArray<Forms::TESObjectREFR*> arrReference;					// 620 Form Type 61 <REFR>
				...
				BSTArray<Forms::TESObjectLAND*> arrLandspace;					// 728 Form Type 72 <LAND>
				TESFormArray arrNAVM;											// 740 Form Type 73
				TESFormArray arrTLOD;											// 758 Form Type 74
				BSTArray<Forms::TESTopic*> arrTopic;							// 770 Form Type 75 <DIAL>
				BSTArray<Forms::TESTopicInfo*> arrTopicInfo;					// 788 Form Type 76 <INFO>
				...
				BSTArray<Forms::BGSVoiceType*> arrVoiceType;					// 998 Form Type 98 <VTYP>
				BSTArray<Forms::BGSMaterialType*> arrMaterialType;				// 9B0 Form Type 99 
				BSTArray<Forms::BGSImpactData*> arrImpactData;					// 9C8 Form Type 100
				BSTArray<Forms::BGSImpactDataSet*> arrImpactDataSet;			// 9E0 Form Type 101
				...
				BSTArray<Forms::BGSFootstep*> arrFootstep;						// AB8 Form Type 110 <FSTP>
				BSTArray<Forms::BGSFootstepSet*> arrFootstepSet;				// AD0 Form Type 111 <FSTS>
				...
				BSTArray<Forms::BGSSoundDescriptorForm*> arrSoundDescriptor;	// C68 Form Type 128
				TESFormArray arrDUAL;											// C80 Form Type 129
				BSTArray<Forms::BGSSoundCategory*> arrSoundCategory;			// C98 Form Type 130 
				BSTArray<Forms::BGSSoundOutput*> arrSoundOutputModel;			// CB0 Form Type 131 
			...
			private:
				void* UnkPtrD48;										// D48
			public:
				NiTPrimitiveArray<Forms::TESObjectCELL*> cellList;		// D50
			...
			public:
				...
				CKPE_READ_PROPERTY(GetActiveMod) TESFile* ActiveMod;
			};
		}
	}
}