// Special thanks to Nukem: https://github.com/Nukem9/SkyrimSETest/blob/master/skyrim64_test/src/patches/TES/BSShader/BSShaderProperty.h
	...
	namespace SkyrimSE
	{
		namespace EditorAPI
		{
			...
			public:
				...
				std::uint64_t QFlags() const;
				bool GetFlag(std::uint32_t FlagIndex) const;

				static const char* GetFlagString(std::uint32_t FlagIndex);
			};
