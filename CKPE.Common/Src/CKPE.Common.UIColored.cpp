...
namespace CKPE
{
	namespace Common
	{
		namespace UI
		{
			...
			constexpr TColor szConstDark[66]
			{
			...
			constexpr TColor szConstDarkGray[66]
			{
			...
			constexpr TColor szConstGray[66]
			{
			...
			constexpr TColor szConstLight[66]
			{
			...
			constexpr TColor szConstNightBlue[66]
			{
			...
			CKPE_COMMON_API TColor* GetThemeColors(const Theme theme) noexcept(true)
			{
				...
				{
				case Theme_Light:
					return const_cast<TColor*>(szConstLight);
				case Theme_Gray:
					return const_cast<TColor*>(szConstGray);
				case Theme_DarkGray:
					return const_cast<TColor*>(szConstDarkGray);
				case Theme_Dark:
					return const_cast<TColor*>(szConstDark);
				case Theme_NightBlue:
					return const_cast<TColor*>(szConstNightBlue);
				}
