...
namespace CKPE
{
	namespace Common
	{
		struct CKPE_COMMON_API D3D11DeviceProxy;
		struct CKPE_COMMON_API D3D11DeviceContextProxy;

		struct CKPE_COMMON_API D3D11DeviceProxy : ID3D11Device2
		{
		...
		struct CKPE_COMMON_API D3D11DeviceContextProxy : ID3D11DeviceContext2
		{
