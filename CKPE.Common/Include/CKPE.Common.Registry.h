...
namespace CKPE
{
	namespace Common
	{
		...
		public:
			...
			virtual void WriteBool(const std::string& valume_name, bool val) noexcept(true);
			virtual void WriteBool(const std::wstring& valume_name, bool val) noexcept(true);
			virtual void WriteFloat(const std::string& valume_name, double val) noexcept(true);
			virtual void WriteFloat(const std::wstring& valume_name, double val) noexcept(true);
			virtual void WriteInteger(const std::string& valume_name, std::int32_t val) noexcept(true);
			virtual void WriteInteger(const std::wstring& valume_name, std::int32_t val) noexcept(true);
			virtual void WriteInt64(const std::string& valume_name, std::int64_t val) noexcept(true);
			virtual void WriteInt64(const std::wstring& valume_name, std::int64_t val) noexcept(true);
			virtual void WriteString(const std::string& valume_name, const std::string& str) noexcept(true);
			virtual void WriteString(const std::wstring& valume_name, const std::wstring& str) noexcept(true);
