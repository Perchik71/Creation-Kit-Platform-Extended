	...
	namespace Fallout4
	{
		...
		public:
			enum EDITOR_EXECUTABLE_TYPE : std::uint32_t
			{
				...
				EDITOR_FALLOUT_C4_1_11_137_0,
				EDITOR_FALLOUT_C4_1_11_240_0,
				EDITOR_FALLOUT_C4_LAST = EDITOR_FALLOUT_C4_1_11_240_0,
			};
			...
			[[nodiscard]] static Common::AddressLibraryEpoch GetAddressLibraryEpoch() noexcept;
		};
	}
}
