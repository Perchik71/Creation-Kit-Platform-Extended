	...
	namespace Common
	{
		namespace UI
		{
			...
			public:
				...
				virtual std::int32_t AddFromResource(THandle hinst, std::uint32_t dwResId, const std::wstring& name, 
					std::uint32_t dwResMaskId = 0) noexcept(true);
				virtual std::int32_t AddFromResourceMasked(THandle hinst, std::uint32_t dwResId, const std::wstring& name,
				...
				virtual bool ReplaceFromResource(std::int32_t idx, THandle hinst, std::uint32_t dwResId, 
					const std::wstring& name, std::uint32_t dwResMaskId = 0) noexcept(true);
