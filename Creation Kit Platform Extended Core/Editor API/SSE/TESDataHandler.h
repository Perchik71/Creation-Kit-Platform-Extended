	...
	namespace EditorAPI
	{
		namespace SkyrimSpectialEdition
		{
			...
			public:
				...
				BSTArray<TESLandTexture*> arrLandTexture;				// 248 Form Type 20
				...
				BSTArray<BGSSoundDescriptorForm*> arrSoundDescriptor;	// C68 Form Type 128
			...
			private:
				void* UnkPtrD48;										// D48
			public:
				NiTPrimitiveArray<TESObjectCELL*> cellList;				// D50
