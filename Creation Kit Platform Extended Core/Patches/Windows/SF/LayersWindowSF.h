	...
	namespace Patches
	{
		namespace Starfield
		{
			...
			private:
				...
				::Core::Classes::UI::CUIBaseControl PushbuttonMinus;
				::Core::Classes::UI::CUIBaseControl Trackbar;
				::Core::Classes::UI::CUIBaseControl TreeView;
				::Core::Classes::UI::CUIBaseControl CheckboxMaintain;
			};
